                        ...
                        >
                            <div className="flex items-center gap-4 mb-10">
                                ...
                                <div>
                                    ...
                                    <h2 className="text-2xl font-medium text-slate-900">Plan (계획 수립)</h2>
                                </div>
                            </div>

                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="bg-slate-50 rounded-lg p-8">
                                    <h3 className="font-medium text-slate-900 mb-3">생애 주기형 계획 (Life-Cycle Planning)</h3>
                                ...
                                <div className="bg-slate-50 rounded-lg p-8">
                                    <h3 className="font-medium text-slate-900 mb-3">시간 예산 관리 (Budgeting)</h3>
                                    <p className="text-slate-600 text-[15px] leading-relaxed">
                        ...
                        >
                            <div className="flex items-center gap-4 mb-10">
                                ...
                                <div>
                                    ...
                                    <h2 className="text-2xl font-medium text-slate-900">Actual (실행 관리) with AI</h2>
                                </div>
                            </div>

                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="bg-white rounded-lg p-8 border border-slate-200">
                                    <h3 className="font-medium text-slate-900 mb-3">AI 학습 관제 (Vision AI)</h3>
                                    <p className="text-slate-600 text-[15px] leading-relaxed">
                                        계획된 시간에 실제로 공부하고 있는지, Edge AI 카메라가
                                        <strong>0.1초 단위</strong>로 '실행 데이터(Actual)'를 감지합니다.
                                    </p>
                                </div>

                                <div className="bg-white rounded-lg p-8 border border-slate-200">
                                    <h3 className="font-medium text-slate-900 mb-3">실시간 행동 개입 (Real-time Nudge)</h3>
                                    <p className="text-slate-600 text-[15px] leading-relaxed">
                        ...
                        >
                            <div className="flex items-center gap-4 mb-10">
                                ...
                                <div>
                                    ...
                                    <h2 className="text-2xl font-medium text-slate-900">Review (분석 및 개선)</h2>
                                </div>
                            </div>

                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="bg-slate-50 rounded-lg p-8">
                                    <h3 className="font-medium text-slate-900 mb-3">실행 오차 분석 (Variance Analysis)</h3>
                                    <p className="text-slate-600 text-[15px] leading-relaxed">
                                ...
                                <div className="bg-slate-50 rounded-lg p-8">
                                    <h3 className="font-medium text-slate-900 mb-3">순환 개선 (Feedback Loop)</h3>
                                    <p className="text-slate-600 text-[15px] leading-relaxed">
